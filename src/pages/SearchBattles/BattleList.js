    ...
    return (
        <div>
            ...
            </List>
            {
                ...
                <div style={{ textAlign: 'right' }}>
                    <Pagination
                        ...
                        boundaryLinks={true}
                        ellipsis={true}
                        pages={Math.ceil(battles.totalDocs / 20)}
                        maxButtons={3}
                        next={true}
                        prev={true}
            ...
            <div style={{marginTop: "1rem", color: "#666"}}>
                <p>I'm currently removing any battle 7 days after it has been parsed. If a battle accessed from a link is not found in the database, it will parse the battle again. I can adjust the time to live higher once I get a sense of how much data can be realistically stored. I aim to hover around 85% capacity to give space for big reset days.</p>
            </div>
        </div>
    )
}
